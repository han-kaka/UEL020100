...
//            for(j=0;j<fillZeroLen;j++)        //ÎªÁËÌîÂúSERVER_IP_LEN(17)³¤¶ÈµÄ×Ö½Ú
//            {
//                TxBuf[i++] = 0;
//            }  
//            
...
///************************ATÖ¸ÁîÓ¦´ðÕýÈ·¡¤**************************/	
//	if(BACK_TRUE == GPRS_ATCmdCB.ATCmdResult)/*ATÖ¸ÁîÓ¦´ðÄÚÈÝÕýÈ·*/
//	{
//		switch(ATCmdIndex)
//		{
//			case GPRS_AT_DATA:
...
//		        GPRS_TimProc.heartbeatCount = 0;      /*ÐÄÌø¼ÆÊýÇåÁã*/
//			}break;	
//			
//			default:
//				break;	
...
//			{
//                g_stGPRS_Handler.State = GPRS_STATE_IDLE;/*ÇÐ»»µ½ÏÂÒ»¸öÁ÷³Ì*/
//				g_stGPRS_Handler.ucCommBusy= 0;/*Comm Complete*/
//			}
//			else
//			{
//				g_stGPRS_Handler.State = GPRS_STATE_COMM;/*¼ÌÐøµ±Ç°Á÷³Ì*/		
//			}
//			
...
//	{
//		/*Ã»ÓÐµ½ATÖ¸ÁîÖØ·¢´ÎÊý£¬ËùÒÔÔÙ´Î·¢ËÍATÖ¸Áî*/
//		g_stGPRS_Handler.State = GPRS_STATE_WAIT_ACK;/*Ö±½ÓÔÙ´Î·¢ËÍATÖ¸Áî£¬È»ºóµÈ´ýÓ¦´ð*/
